...
local function deep_copy(t, dest, aType)
	...
	for k,v in pairs(t) do
		if aType ~= nil and type(v) == aType then
			r[k] = (type(v) == 'table' and v.__index ~= vec2.__index) -- Krunk: Override to check for brinevector tables
...
local function instantiate(call_init, self, ...)
	...
	instance.__newindex = nil -- Krunk: Added for get and set functionality
	instance.mixins = nil
